        ...
        {data && (
          <button
            ...
            onClick={async () => {
              ...
              const toRows = (groups: SectionGroup[]) =>
                groups.flatMap((g) => g.accounts.map((a) => ({ accountCode: a.code, accountName: a.name, accountType: g.accountTypeLabel, debit: 0, credit: 0, balance: Number(a.balance ?? 0) })));
