                ...
                >
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="space-y-1">
                      <p className="text-muted-foreground text-sm font-medium">Credit used</p>
                      <p className="bg-muted/40 rounded-md border px-3 py-2 font-mono text-sm">
                        {Number(data.creditUsed ?? 0).toLocaleString(undefined, {
                          minimumFractionDigits: 2,
                        })}
                      </p>
                      <p className="text-muted-foreground text-xs">
                        Moves with confirmed bookings and payments.
                      </p>
                    </div>
                    <FormField
                      control={form.control}
